...
$query = "insert into principal (celula,cdoe_i,endereco,data_atv,causa,sub_causa,servico,data_cad,tecnico,obs,foto,atividade,nome,tipo,cad_por,tipo2,localidade,cabo,cabo_metro,caixa,equipe,ba,tipo_ba,rede)";

$query.= "values ('$celula','$cdoe_i','$endereco','$data_atv','$causa','$sub','$servico',NOW(),'$id','$obs','$novo_nome','$atv','$nome','$tipo','".$_SESSION['nome']."','$tipo2','$local','$cabo','$cabo_metro','$caixa','$equipe','$ba','$tipo_ba','$rede')";
