...
<div class="row content">
  ...
  <textarea class="form-control" rows="5" maxlength="1000" id="obs" name="obs" > <?php echo $obs;?> </textarea>
    </div>
    <input type="hidden" class="form-control"  name="protocolo" value="<?php echo $protocolo ?>" >
     ...
     <br><br><button type="submit" value="Enviar" class="btn btn-warning" id="submit" required > <strong>Editar</strong> </button><br><br><br><br>
