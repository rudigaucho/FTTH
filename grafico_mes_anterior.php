...
//---------------------------------------- GRÁFICO EQUIPES BACKLOG  -------------------------------------------------
 ...
 $sql50 = mysql_query ("SELECT count(*) as total ,(select COUNT(*)  from PRINCIPAL WHERE EQUIPE = '1' and MONTH(data_atv) = '$mes' and year(data_atv) = '$ano') as eqp1,(select COUNT(*)  from PRINCIPAL WHERE EQUIPE = '2' and MONTH(data_atv) = '$mes' and year(data_atv) = '$ano') as eqp2,(select COUNT(*)  from PRINCIPAL WHERE EQUIPE = '3' and MONTH(data_atv) = '$mes' and year(data_atv) = '$ano') as eqp3,(select COUNT(*)  from PRINCIPAL WHERE EQUIPE = '4' and MONTH(data_atv) = '$mes' and year(data_atv) = '$ano') as eqp4,(select COUNT(*)  from PRINCIPAL WHERE EQUIPE = '5' and MONTH(data_atv) = '$mes' and year(data_atv) = '$ano') as eqp5" );
